...
from demo_data import (MyAlphaProvider, MyBenchmarkWeightsProvider,
                       MyBetaProvider, MyCalendarProvider,
...
betas_provider = MyBetaProvider(db, start, end)
...
optimizer = MVO(
    ...
    constraints=[LongOnly(), FullyInvested(), TargetBeta(target_beta=1)]
)
